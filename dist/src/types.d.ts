...
export type StreamFunctionType = (sql: TaggedTemplateLiteralInvocationType, streamHandler: StreamHandlerType) => Promise<Record<string, unknown> | null>;
...
export type PrimitiveValueExpressionType = Buffer | boolean | number | string | readonly PrimitiveValueExpressionType[] | null;
...
export type SqlTaggedTemplateType<T extends UserQueryResultRowType = QueryResultRowType> = {
    ...
    unnest: (tuples: ReadonlyArray<readonly any[]>, columnTypes: readonly UnnestSqlColumnType[]) => UnnestSqlTokenType;
};
...
export type InternalTransactionFunctionType = <T>(log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, handler: TransactionFunctionType<T>, transactionRetryLimit?: number) => Promise<T>;
export type InternalNestedTransactionFunctionType = <T>(log: Logger, connection: InternalDatabaseConnectionType, clientConfiguration: ClientConfigurationType, handler: TransactionFunctionType<T>, transactionDepth: number, transactionRetryLimit?: number) => Promise<T>;
...
export type QueryAnyFirstFunctionType = <T, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<ReadonlyArray<Row[keyof Row]>>;
export type QueryAnyFunctionType = <T>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<readonly T[]>;
...
export type QueryFunctionType = <T>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<QueryResultType<T>>;
export type QueryManyFirstFunctionType = <T, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<ReadonlyArray<Row[keyof Row]>>;
export type QueryManyFunctionType = <T>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<readonly T[]>;
export type QueryMaybeOneFirstFunctionType = <T, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<Row[keyof Row] | null>;
export type QueryMaybeOneFunctionType = <T>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<T | null>;
export type QueryOneFirstFunctionType = <T, Row = Record<string, T>>(sql: TaggedTemplateLiteralInvocationType<Row>, values?: PrimitiveValueExpressionType[]) => Promise<Row[keyof Row]>;
export type QueryOneFunctionType = <T extends UserQueryResultRowType = UserQueryResultRowType>(sql: TaggedTemplateLiteralInvocationType<T>, values?: PrimitiveValueExpressionType[]) => Promise<T>;
